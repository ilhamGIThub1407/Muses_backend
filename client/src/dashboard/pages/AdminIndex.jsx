            ...
            <tbody>
              {[1, 2, 3, 4, 5, 6, 7].map((n, i) => (
                <tr key={i} className="bg-white border-b">
                  ...
                  <td className="px-6 py-4">
                    <span className="px-2 py-0.5 bg-green-100 text-green-800 rounded-lg text-xs cursor-pointer">
                      active
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex justify-start items-center gap-x-4 text-white">
                      <Link className="p-0.5 bg-green-500 rounded hover:shadow-lg hover:shadow-green-500/50">
                        <FaEye />
                      </Link>
                    </div>
                  </td>
