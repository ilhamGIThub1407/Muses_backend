      ...
      <div className="w-full h-full relative">
        ...
        <div className="absolute bg-white w-[50%] p-3 rounded-sm h-[85vh] overflow-y-auto left-[50%] top-[50%] z-999 -translate-x-[50%] -translate-y-[50%]">
          ...
          <div>
            <label
              htmlFor="images"
              className={`w-full h-45 flex rounded text-[#404040] gap-2 justify-center items-center cursor-pointer border-2 border-dashed`}
            >
            ...
            {images.length > 0 &&
              images.map((img, i) => (
                <div
                  ...
                  key={i}
                >
                  <img src={img.url} alt="image" className="w-full h-25" />
                </div>
              ))}
          </div>
        </div>
